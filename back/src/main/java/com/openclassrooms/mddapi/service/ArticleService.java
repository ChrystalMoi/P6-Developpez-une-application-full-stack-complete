...
public interface ArticleService {
     ...
     */
    Article getArticleById(final Long articleId) throws ArticleNotFoundException;
     ...
     */
    void saveArticle(Article article) throws ArticleNotFoundException;
     ...
     */
    List<Article> getAllArticlesWithThemeId(final Long id);
     ...
     */
    List<Article> getAllArticlesInThemeIds(final List<Long> ids);
}
